...
export function IframeBlockedState({ url, onRetry, onCapture }: IframeBlockedStateProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-3 bg-vpbg px-8 text-center" data-ai-id="iframe-blocked-state">
      <div className="text-[15px] font-semibold text-white" data-ai-id="iframe-blocked-state-title-text">
        미리보기가 차단되었을 수 있습니다
      </div>
      <p className="max-w-[420px] text-[13px] leading-5 text-slate-400" data-ai-id="iframe-blocked-state-description-text">
